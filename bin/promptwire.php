 ...
 * 
 * Usage:
 *   php promptwire.php <command> [arguments] [--flags]
 * 
 * Examples:
 *   php promptwire.php health --pretty
 *   php promptwire.php list-templates
 *   php promptwire.php get-page /about/ --include=files
 *   php promptwire.php export-schema --format=yaml
 * 
