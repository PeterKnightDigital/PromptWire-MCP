<?php
/**
 * PromptWire API Configuration
 *
 * SETUP
 * -----
 * 1. Copy this file to your ProcessWire site's config directory:
 *      cp config-promptwire.example.php /path/to/remote-site/site/config-promptwire.php
 *
...
define('PROMPTWIRE_API_KEY', 'REPLACE_WITH_A_STRONG_RANDOM_KEY');
